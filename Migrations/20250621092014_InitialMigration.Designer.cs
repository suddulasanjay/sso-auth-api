...
namespace SSOAuthAPI.Migrations
{
    ...
    [Migration("20250621092014_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication<string>", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_application_string");

                    b.HasAlternateKey("ClientId")
                        .HasName("ak_open_iddict_entity_framework_core_application_string_client_id");

                    b.ToTable("open_iddict_entity_framework_core_application_string", "trans");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization<string>", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_authorization_string");

                    b.HasIndex("ApplicationId")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_authorization_string_application_id");

                    b.ToTable("open_iddict_entity_framework_core_authorization_string", "trans");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken<string>", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_token_string");

                    b.HasIndex("ApplicationId")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_token_string_application_id");

                    b.HasIndex("AuthorizationId")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_token_string_authorization_id");

                    b.ToTable("open_iddict_entity_framework_core_token_string", "trans");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization<string>", b =>
                {
                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication<string>", "Application")
                        .WithMany("Authorizations")
                        .HasForeignKey("ApplicationId")
                        .HasConstraintName("fk_open_iddict_entity_framework_core_authorization_string_open_iddict_entity_framework_core_application_string_application_id");
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken<string>", b =>
                {
                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication<string>", "Application")
                        .WithMany("Tokens")
                        .HasForeignKey("ApplicationId")
                        .HasConstraintName("fk_open_iddict_entity_framework_core_token_string_open_iddict_entity_framework_core_application_string_application_id");

                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization<string>", "Authorization")
                        .WithMany("Tokens")
                        .HasForeignKey("AuthorizationId")
                        .HasConstraintName("fk_open_iddict_entity_framework_core_token_string_open_iddict_entity_framework_core_authorization_string_authorization_id");
            ...
            modelBuilder.Entity("SSOAuthAPI.Data.Entities.UserClient", b =>
                {
                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication<string>", "App")
                        .WithMany()
                        .HasForeignKey("AppId")
                        .HasPrincipalKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_clients_open_iddict_entity_framework_core_application_string_app_id");
